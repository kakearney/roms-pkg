...
%     Opt.tname,      1,        true);
% 
% dused = cellfun(@(x) Dims.(x), setdiff(unique(V.grid), ''), 'uni', 0);
% dused = unique(cat(2, dused{:}));
% 
% tf = ismember({Nc.Dimensions.Name}, [dused Opt.tname]);
% Nc.Dimensions = Nc.Dimensions(tf);
...
% 
% 
% % Add reference parameters (dimensionless)
% 
% if Opt.addreference
% 
...
% 
%         if Opt.spherical
%             Nc = ncschema_addvars(Nc, ['lat_rho_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['latitude of RHO-points, ', blong{ib}], ...
%                                   'units', 'degrees north' ...
%                                   'standard_name',  'latitude'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['lon_rho_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['longitude of RHO-points, ', blong{ib}], ...
%                                   'units', 'degrees east' ...
%                                   'standard_name',  'longitude'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['lat_u_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['latitude of U-points, ', blong{ib}], ...
%                                   'units', 'degrees north' ...
%                                   'standard_name',  'latitude'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['lon_u_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['longitude of U-points, ', blong{ib}], ...
%                                   'units', 'degrees east' ...
%                                   'standard_name',  'longitude'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['lat_v_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['latitude of V-points, ', blong{ib}], ...
%                                   'units', 'degrees north' ...
%                                   'standard_name',  'latitude'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['lon_v_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['longitude of V-points, ', blong{ib}], ...
%                                   'units', 'degrees east' ...
%                                   'standard_name',  'longitude'}, ...
%                                  'double');
%         else
%             Nc = ncschema_addvars(Nc, ['y_rho_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['Y-location of RHO-points, ', blong{ib}], ...
%                                   'units', 'meter'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['x_rho_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['X-location of RHO-points, ', blong{ib}], ...
%                                   'units', 'meter'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['y_u_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['Y-location of U-points, ', blong{ib}], ...
%                                   'units', 'meter'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['x_u_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['X-location of U-points, ', blong{ib}], ...
%                                   'units', 'meter'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['y_v_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['Y-location of V-points, ', blong{ib}], ...
%                                   'units', 'meter'}, ...
%                                  'double');
%             Nc = ncschema_addvars(Nc, ['x_v_' bshort{ib}], ...
%                                  {xdim}, ...
%                                  {'long_name', ['X-location of V-points, ', blong{ib}], ...
%                                   'units', 'meter'}, ...
%                                  'double');
%         end
%     end
...
%     end
%     
%     Nc = ncschema_addvars(Nc, ['zeta_' bshort{ib}], ...
%                           {[xdim '_rho'], Opt.tname}, ...
%                           {'long_name', ['free surface, ', blong{ib}], ...
%                            'units', 'meter', ...
%                            'time', Opt.tname, ...
%                            'coordinates', sprintf('%s_rho_%s %s_rho_%s %s', xprefix, bshort{ib}, yprefix, bshort{ib}, Opt.tname)}, ...
%                           'double');
%                       
%     Nc = ncschema_addvars(Nc, ['ubar_' bshort{ib}], ...
%                           {[xdim '_u'], Opt.tname}, ...
%                           {'long_name', ['vertically integrated u-momentum component, ', blong{ib}], ...
%                            'units', 'meter second-1', ...
%                            'time', Opt.tname, ...
%                            'coordinates', sprintf('%s_u_%s %s_u_%s %s', xprefix, bshort{ib}, yprefix, bshort{ib}, Opt.tname)}, ...
%                           'double');
%                       
%     Nc = ncschema_addvars(Nc, ['vbar_' bshort{ib}], ...
%                           {[xdim '_v'], Opt.tname}, ...
%                           {'long_name', ['vertically integrated v-momentum component, ', blong{ib}], ...
%                            'units', 'meter second-1', ...
%                            'time', Opt.tname, ...
%                            'coordinates', sprintf('%s_v_%s %s_v_%s %s', xprefix, bshort{ib}, yprefix, bshort{ib}, Opt.tname)}, ...
%                           'double');
%                       
%     Nc = ncschema_addvars(Nc, ['u_' bshort{ib}], ...
%                           {[xdim '_u'], 's_rho', Opt.tname}, ...
%                           {'long_name', ['u-momentum component, ', blong{ib}], ...
%                            'units', 'meter second-1', ...
%                            'time', Opt.tname, ...
%                            'coordinates', sprintf('%s_u_%s %s_u_%s s_rho %s', xprefix, bshort{ib}, yprefix, bshort{ib}, Opt.tname)}, ...
%                           'double');
%                       
%     Nc = ncschema_addvars(Nc, ['v_' bshort{ib}], ...
%                           {[xdim '_v'], 's_rho', Opt.tname}, ...
%                           {'long_name', ['v-momentum component, ', blong{ib}], ...
%                            'units', 'meter second-1', ...
%                            'time', Opt.tname, ...
%                            'coordinates', sprintf('%s_v_%s %s_v_%s s_rho %s', xprefix, bshort{ib}, yprefix, bshort{ib}, Opt.tname)}, ...
%                           'double');
%                       
%                       
%     Nc = ncschema_addvars(Nc, ['temp_' bshort{ib}], ...
%                           {[xdim '_rho'], 's_rho', Opt.tname}, ...
%                           {'long_name', ['potential temperature, ', blong{ib}], ...
%                            'units', 'Celsius', ...
%                            'time', Opt.tname, ...
%                            'coordinates', sprintf('%s_rho_%s %s_rho_%s s_rho %s', xprefix, bshort{ib}, yprefix, bshort{ib}, Opt.tname)}, ...
%                           'double');
%                       
%     Nc = ncschema_addvars(Nc, ['salt_' bshort{ib}], ...
%                           {[xdim '_rho'], 's_rho', Opt.tname}, ...
%                           {'long_name', ['salinity, ', blong{ib}], ...
%                            'time', Opt.tname, ...
%                            'coordinates', sprintf('%s_rho_%s %s_rho_%s s_rho %s', xprefix, bshort{ib}, yprefix, bshort{ib}, Opt.tname)}, ...
%                           'double');
% 
